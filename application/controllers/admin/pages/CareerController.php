...
class CareerController extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->data['banner_data']= $this->CommonModel->RetriveRecordByWhereOrderby('tbl_pages',['status<>'=>'Delete','type'=>'career','name' => 'career'],'id','desc');

		$this->data['page_title']='NNIT | career';
		$this->data['subview']='pages/career';
				...
				'current_date' => date('Y-m-d H:i:s')
						...
						if(!empty($_FILES['image']['name']))
						{
							...
							if($this->upload->do_upload('image'))
							{
								...
								$config['new_image'] = 'webroot/admin/bannercareer/'.$image_data['file_name'];
								$config['width'] = 500;
								$config['height'] = 400;
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="'.base_url('admin/pages/career/update').'" id="portfolio" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <div class="form-group">
                                            <img src="'.base_url('webroot/admin/bannercareer/'.$banner_row->image.'').'" id="upload_portfolio" onclick="get_upload_portfolio()" class="add_img_button">
	 ...
	 //    $this->load->library('form_validation');
		...
		// {
			...
			if($_FILES['image']['name'] == "")
			{
					...
					$this->session->set_flashdata('success', 'career update successfully.');
					redirect('admin/page-career');
			}
			else
			{
				...
				if(!empty($_FILES['image']['name']))
				{
					...
					if($this->upload->do_upload('image'))
					{
						...
						$file = FCPATH.'/webroot/admin/bannercareer/'.$old_image;
						if(file_exists($file))
						{
							unlink($file);
						}
