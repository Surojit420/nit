...
class QuotationController extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->data['banner_data']= $this->CommonModel->RetriveRecordByWhereOrderby('tbl_pages',['status<>'=>'Delete','type'=>'quotation','name'=>'quotation'],'id','desc');

		$this->data['page_title']='NNIT | quotation';
		$this->data['subview']='pages/quotation';
				...
				'current_date' => date('Y-m-d H:i:s')
						...
						if(!empty($_FILES['image']['name']))
						{
							...
							if($this->upload->do_upload('image'))
							{
								...
								$config['new_image'] = 'webroot/admin/bannerquotation/'.$image_data['file_name'];
								$config['width'] = 500;
								$config['height'] = 400;
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="'.base_url('admin/pages/quotation/update').'" id="portfolio" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <div class="form-group">
                                            <img src="'.base_url('webroot/admin/bannerquotation/'.$banner_row->image.'').'" id="upload_portfolio" onclick="get_upload_portfolio()" class="add_img_button">
	...
	public function update()
	{
	 //    $this->load->library('form_validation');
		...
		// $this->form_validation->set_rules('head', 'head');
		// // $this->form_validation->set_rules('name', 'quotation', 'required');
		// // $this->form_validation->set_rules('description', 'Description', 'required');
			...
			else
			{
				...
				if(!empty($_FILES['image']['name']))
				{
					...
					if($this->upload->do_upload('image'))
					{
						...
						$file = FCPATH.'/webroot/admin/bannerquotation/'.$old_image;
						if(file_exists($file))
						{
							unlink($file);
						}
