                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/add_technologies')?>" id="technologies" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <img src="<?=base_url('webroot/admin/images/Add-Photo-Button.png')?>" id="upload_technologies" onclick="get_upload_technologies()" class="add_img_button">
                            ...
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <?php foreach ($tec_data as $key => $value) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/technologies/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="<?=base_url('admin/technologies/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this technologies?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>    
                                    </tr>
                                <?php }?>
