                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/add_workflow')?>" id="workflow" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <img src="<?=base_url('webroot/admin/images/Add-Photo-Button.png')?>" id="upload_workflow" onclick="get_upload_workflow()" class="add_img_button">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" name="banner_name" id="banner_name" class="form-control validate[required]" data-errormessage-value-missing="Name is required" data-prompt-position="bottomLeft" placeholder="Enter name" maxlength="200">     
                                        </div> 
                                    </div>
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="save_submit" style="margin-left: 756px;" onclick="checkworkflow()"><strong>Save<strong></button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <?php foreach ($banner_data as $key => $value) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/workflow/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="<?=base_url('admin/workflow/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this workflow?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>    
                                    </tr>
                                <?php }?>
