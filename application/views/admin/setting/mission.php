    ...
    <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/add_mission')?>" id="mission" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <img src="<?=base_url('webroot/admin/images/Add-Photo-Button.png')?>" id="upload_mission" onclick="get_upload_mission()" class="add_img_button">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-primary"  id="save_submit" style="margin-left: 756px;" onclick="checkmission()"><strong>Save<strong></button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mission Data</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <tbody>
                                <?php foreach ($mission_data as $key => $value) {?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/mission/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="<?=base_url('admin/mission/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this mission?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>    
                                    </tr>
                                <?php }?>
