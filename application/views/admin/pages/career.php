    ...
    <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/page-addcareer')?>" id="portfolio" method="post" enctype="multipart/form-data">
                                <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">career Data</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <?php foreach ($banner_data as $key => $value) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/bannercareer/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="checkbox" class="js-switch" onchange="common_status_change_pages(this.value,'career')" id="status" value="<?=$value->uniqcode?>" <?=$value->status == 'Active' ? 'checked' : ''?> /></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="javascript:void(0)" class="btn btn-primary shadow btn-xs sharp mr-1" onclick="edit_action_pages('<?=$value->uniqcode?>','page-career')" id="get_action_val_<?=$value->uniqcode?>"> <i class="fa fa-pencil"></i></a>

                                                <a href="<?=base_url('admin/page-career/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this career?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
