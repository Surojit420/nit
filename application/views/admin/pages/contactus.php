                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/page-addcontactus')?>" id="portfolio" method="post" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-lg-12 text-center">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                           ...
                                           <textarea rows="2" cols="30" style="resize: none;"  name="description" id="description" class="form-control " 
                                           data-prompt-position="bottomLeft"placeholder="Enter banner description" ></textarea> 
                                       </div> 
                                    </div>
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                           ...
                                           <textarea rows="2" cols="30" style="resize: none;"  name="close_body" id="description" class="form-control " 
                                           data-prompt-position="bottomLeft"placeholder="Enter code before tag" ></textarea> 
                                       </div> 
                                    </div>
                                </div>
                                <div class="col-sm-12">
                            ...
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <?php foreach ($banner_data as $key => $value) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/bannercontactus/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="checkbox" class="js-switch" onchange="common_status_change_pages(this.value,'contactus')" id="status" value="<?=$value->uniqcode?>" <?=$value->status == 'Active' ? 'checked' : ''?> /></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="javascript:void(0)" class="btn btn-primary shadow btn-xs sharp mr-1" onclick="edit_action_pages('<?=$value->uniqcode?>','page-contactus')" id="get_action_val_<?=$value->uniqcode?>"> <i class="fa fa-pencil"></i></a>

                                                <a href="<?=base_url('admin/page-contactus/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this contactus?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
