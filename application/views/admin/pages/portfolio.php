                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form  action="<?=base_url('admin/page-addportfolio')?>" id="portfolio" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                           ...
                                           <textarea rows="2" cols="30" style="resize: none;"  name="description" id="description" class="form-control " 
                                            data-prompt-position="bottomLeft"placeholder="Enter description" ></textarea> 
                                       </div> 
                                    </div>
                                    <div class="col-lg-12">
                                       <div class="form-group">
                            ...
                            <table id="example" class="display" style="min-width: 854px">
                                ...
                                <?php foreach ($banner_data as $key => $value) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('webroot/admin/bannerportfolio/'.$value->image)?>" class="showTableImage" id="product_img">
                                        </td>
                                        <td>  
                                          <textarea rows="2" cols="30" style="resize:none;width:210px;height:108px;border:none;"readonly id="description" class="form-control "><?=$value->head?></textarea> 
                                        ...
                                        <td>
                                            <input type="checkbox" class="js-switch" onchange="common_status_change_pages(this.value,'portfolio')" id="status" value="<?=$value->uniqcode?>" <?=$value->status == 'Active' ? 'checked' : ''?> /></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="javascript:void(0)" class="btn btn-primary shadow btn-xs sharp mr-1" onclick="edit_action_pages('<?=$value->uniqcode?>','page-portfolio')" id="get_action_val_<?=$value->uniqcode?>"> <i class="fa fa-pencil"></i></a>

                                                <a href="<?=base_url('admin/page-portfolio/destroy/'.$value->uniqcode)?>" onclick="return confirm('Are you sure delete this portfolio?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
