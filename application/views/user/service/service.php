          ...
          <div class="website-development">
            <div class="container">
              <div class="col-md-6 col-sm-8">
                <h3 class="section-heading wow animate__animated animate__backInDown"><?=$services_details->services_name?></h3>
                <p class="section-content wow animate__animated animate__backInUp">
                  <?=$services_details->banner_description?>
                </p>
              ...
              <div class="php-development">
                <div class="container">
                  ...
                  <div class="col-md-7 col-sm-7">
                    ...
                    <a href="blog.html" class="btn_3 wow animate__animated animate__backInLeft">Get A Free Quote</a>
                  </div>
                </div>
              </div>
            <?php
